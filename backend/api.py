...
# Add Rate Limiting (path-specific limits in middleware)
app.add_middleware(RateLimitMiddleware, limit=60, window=60)

# Add Request Tracking (generates unique request IDs for debugging)
app.add_middleware(RequestTrackingMiddleware)

# Add Cache Headers (sets appropriate cache headers for GET endpoints)
app.add_middleware(CacheHeadersMiddleware)

# Add Security Headers (XSS protection, content type sniffing, etc.)
